...
use App\Http\Controllers\Api\Seller\SubscriptionPlanApiController;
...
Route::post('/webhook/razorpay', [RazorpayController::class, 'handleWebhook'])->name('razorpay.webhook');
